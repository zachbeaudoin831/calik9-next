...
const FORM_ID = "ZKQhZUrz6MJ0NYOiS9IW";

export default function BuyModal({ className = "" }: { className?: string }) {
    ...
    <>
      ...
      {open && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Complete your $79 order"
        >
          {/* Backdrop */}
          <button
            type="button"
          ...
          {/* Panel */}
          <div className="relative w-full max-w-[600px] max-h-[94vh] overflow-y-auto bg-white rounded-xl shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
            <button
              type="button"
              onClick={close}
              aria-label="Close"
            ...
            <div className="px-7 pt-8 pb-2 max-[480px]:px-5 text-center">
              <span className="inline-flex items-center gap-2 bg-[#F59E0B] text-ink font-ui text-[11px] font-bold tracking-[2px] uppercase px-3 py-1.5 rounded-full mb-4">
                Webinar Special &middot; $79 One-Time
              </span>
              ...
              <p className="font-body text-sm text-gray-muted leading-relaxed">
                Full online training system + one-on-one evaluation call.
            ...
            <div className="px-4 pb-4">
              <iframe
                ...
                data-form-name="$79 Webinar Special - Website"
                data-height="789"
                data-layout-iframe-id={`inline-${FORM_ID}`}
                data-form-id={FORM_ID}
                title="$79 Webinar Special - Website"
                allow="payment *"
            ...
            <p className="font-body text-[11px] text-gray-muted/70 text-center px-6 pb-5">
              All sales are final. Cali K9&reg; does not issue refunds.
            </p>
          </div>
