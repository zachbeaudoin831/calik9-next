  ...
  return (
    <main className="bg-white text-[#0D0D0D]">
      <style>{`
        ...
        .chat-widget-container,
        #lc-chat-widget,
        iframe[src*="leadconnectorhq.com"]:not([data-form-id]),
        iframe[src*="msgsndr.com"]:not([data-form-id]),
        div[data-widget-id],
        #LeadConnector,
        .lc-chat-bubble,
        .lc-chat-wrapper,
      ...
      {/* ════════════ HERO ════════════ */}
      <div className="bg-white border-b border-gray-200 pt-10 pb-16 max-md:pt-8 max-md:pb-10 px-6 text-center">
        <div className="max-w-[760px] mx-auto">
          <div className="inline-block bg-amber-50 border border-amber-300 text-[#D4820A] font-ui text-[11px] font-bold tracking-[3px] uppercase px-5 py-2.5 rounded-sm mb-10">
          ...
          <h1 className="font-display text-[clamp(34px,5.5vw,56px)] text-[#0D0D0D] leading-[1.0] uppercase mb-4">
            Who Netflix, Your Favorite Celebrity, and Millions of Social Media Followers All Trust &mdash;{" "}
