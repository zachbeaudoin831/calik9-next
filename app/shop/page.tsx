...
export default function ShopPage() {
  ...
  return (
    <>
      {/* ── Hero (compact) ── */}
      <section className="relative overflow-hidden pt-[104px] pb-14 max-md:pt-24 max-md:pb-10" style={{ background: "linear-gradient(135deg, #122E85 0%, #122E85 50%, #1A3FAB 100%)" }}>
        <div className="max-w-[1200px] mx-auto px-10 max-md:px-6 max-[480px]:px-4 relative z-[1] flex items-center justify-between gap-6 flex-wrap">
          <div>
