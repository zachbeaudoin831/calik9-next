...
export default function Nav() {
  ...
  const isServicePage = pathname.startsWith("/services") || pathname.startsWith("/online-training") || pathname.startsWith("/in-person") || pathname.startsWith("/board-and-train") || pathname.startsWith("/vip-with-jas") || pathname.startsWith("/semi-private") || pathname.startsWith("/memberships") || pathname.startsWith("/coaching") || pathname.startsWith("/starter-course");
