...
const STICKY_BAR_PAGES: Record<string, { text: string; cta: string; href: string }> = {
  "/in-person": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "https://go.calik9.com/evaluation-with-jas" },
  "/online-training-program2": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "https://go.calik9.com/evaluation-with-jas" },
  "/board-and-train": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "https://go.calik9.com/evaluation-with-jas" },
  "/semi-private": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "https://go.calik9.com/evaluation-with-jas" },
  "/zoom-group-class": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "https://go.calik9.com/evaluation-with-jas" },
