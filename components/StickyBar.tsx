...
const STICKY_BAR_PAGES: Record<string, { text: string; cta: string; href: string }> = {
  "/in-person": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "/evaluation-with-behavior-specialist" },
  "/online-training-program2": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "/evaluation-with-behavior-specialist" },
  "/board-and-train": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "/evaluation-with-behavior-specialist" },
  "/semi-private": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "/evaluation-with-behavior-specialist" },
  "/zoom-group-class": { text: "Don’t Know Which Program Fits Your Dog?", cta: "Book an Evaluation →", href: "/evaluation-with-behavior-specialist" },
